...
MODEL                := positionpid_rtsim
MODULES              := positionpid_rtsim_data.c positionpid_rtsim_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := positionpid_rtsim.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := positionpid_rtsim_ref.rsp
...
# additional includes
REQ_INCLUDES += ;Z:/windows_profile/Desktop/CELAB/CELAB_LAB3;Z:/windows_profile/Desktop/CELAB/CELAB_LAB3/positionpid_rtsim_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
