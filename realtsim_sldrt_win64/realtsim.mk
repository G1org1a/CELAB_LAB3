...
MODEL                := realtsim
MODULES              := realtsim_data.c realtsim_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := realtsim.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := realtsim_ref.rsp
...
# additional includes
REQ_INCLUDES += ;Z:/windows_profile/Desktop/CELAB/CELAB_LAB3;Z:/windows_profile/Desktop/CELAB/CELAB_LAB3/realtsim_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
