...
#ifndef RTW_HEADER_thd_acq_h_
#define RTW_HEADER_thd_acq_h_
#ifndef thd_acq_COMMON_INCLUDES_
#define thd_acq_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* thd_acq_COMMON_INCLUDES_ */

#include "thd_acq_types.h"
#include "rtGetInf.h"
#include <stddef.h>
...
#define thd_acq_rtModel                RT_MODEL_thd_acq_T
...
#define rtB                            thd_acq_B
#define BlockIO                        B_thd_acq_T
#define rtP                            thd_acq_P
#define Parameters                     P_thd_acq_T
#define rtDWork                        thd_acq_DW
#define D_Work                         DW_thd_acq_T

/* Parameters (default storage) */
struct P_thd_acq_T_ {
  real_T V2deg;                        /* Variable: V2deg
...
extern P_thd_acq_T thd_acq_P;

/* Block signals (default storage) */
extern B_thd_acq_T thd_acq_B;

/* Block states (default storage) */
extern DW_thd_acq_T thd_acq_DW;

/* External data declarations for dependent source files */
extern const real_T thd_acq_RGND;      /* real_T ground */

/* Model entry point functions */
extern void thd_acq_initialize(void);
extern void thd_acq_output(void);
extern void thd_acq_update(void);
extern void thd_acq_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern thd_acq_rtModel *thd_acq(void);
...
extern RT_MODEL_thd_acq_T *const thd_acq_M;
 ...
 *
 * '<Root>' : 'thd_acq'
 * '<S1>'   : 'thd_acq/Beam Displacement sensing'
 * '<S2>'   : 'thd_acq/Beam Displacement sensing/Bias Estimation'
 * '<S3>'   : 'thd_acq/Beam Displacement sensing/Bias Estimation/Enabled Subsystem'
 * '<S4>'   : 'thd_acq/Beam Displacement sensing/Bias Estimation/Interval Test'
 */
#endif                                 /* RTW_HEADER_thd_acq_h_ */
