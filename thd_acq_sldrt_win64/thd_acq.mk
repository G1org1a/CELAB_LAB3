...
MODEL                := thd_acq
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c thd_acq_data.c thd_acq_tgtconn.c
MAKEFILE             := thd_acq.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := thd_acq_ref.rsp
...
# additional includes
REQ_INCLUDES += ;Z:/windows_profile/Desktop/CELAB/CELAB_LAB3;Z:/windows_profile/Desktop/CELAB/CELAB_LAB3/thd_acq_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
